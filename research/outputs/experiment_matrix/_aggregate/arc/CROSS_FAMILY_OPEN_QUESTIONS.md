...
| Does boundary location appear capability-linked? | partially answered | The weak Qwen control stays early, but the higher-capability Qwen follow-up does not show a matching late boundary, so capability linkage is still incomplete. |
