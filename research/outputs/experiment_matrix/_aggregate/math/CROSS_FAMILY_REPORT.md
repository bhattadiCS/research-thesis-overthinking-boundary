...
## Executive Summary
A clearly late corrected boundary replicates in 1 capable run(s) across 1 family/families: Qwen 32B (step 6). An additional 1 run(s) across 1 family/families (Qwen2.5 instruct) add weaker late-boundary support: Qwen 7B (step 4). Late-boundary evidence remains confined to a single capable family, so cross-family robustness is not yet established.
...
| Qwen 7B | Qwen2.5 instruct | 7B | transformers+torch(cuda) | none | 0.1093 | 0.3893 | 13 | 4 | 0.0425 | 0.0820 | 0.2113 | 0.2080 | 0.5787 | 0.1918 | 0.7809 | Weakened late-boundary support |
...
| Qwen 7B | e_process | 2 | 0.2080 | 0.897 |
| Qwen 7B | first_answer | 3 | 0.2087 | 0.000 |
...
| Qwen 7B | self-reported confidence (confidence, coeff=1.353) | answer revision flag (answer_changed, coeff=0.761) |
