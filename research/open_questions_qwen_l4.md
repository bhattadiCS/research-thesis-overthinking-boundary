...
Answer: Partially yes. The hazard-based stop rule reached mean oracle gap 0.1531 with false-late rate 0.996, while the empirical-Bernstein detector reached 0.4106, and the new mixture e-process reached 0.0595. The pooled repair and corruption rates were 0.003 and 0.024, so the hazards are learnable enough to drive a practical detector, although still conservatively.
